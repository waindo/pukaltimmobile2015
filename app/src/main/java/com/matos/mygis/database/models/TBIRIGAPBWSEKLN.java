...
public class TBIRIGAPBWSEKLN {
    ...
    private int Nama_Saluran_Pembawa_Sekunder;
    ...
    public int getNama_Saluran_Pembawa_Sekunder() {
        return Nama_Saluran_Pembawa_Sekunder;
    }

    public void setNama_Saluran_Pembawa_Sekunder(int nama_Saluran_Pembawa_Sekunder) {
    ...
    public TBIRIGAPBWSEKLN() {
    }

    public TBIRIGAPBWSEKLN(int pId, int pOBJECTID, int pKodeAset, int pNama_Jaringan_Irigasi, int pNama_Saluran_Pembawa_Sekunder, int pKondisi_Pelapisan, String pKondisi,String pInformasi_Tambahan) {
        setId(pId);
    ...
    // Untuk insert data
    public TBIRIGAPBWSEKLN(int pOBJECTID, int pKodeAset, int pNama_Jaringan_Irigasi, int pNama_Saluran_Pembawa_Sekunder, int pKondisi_Pelapisan, String pKondisi,String pInformasi_Tambahan) {
        setOBJECTID(pOBJECTID);
        setKodeaset(pKodeAset);
