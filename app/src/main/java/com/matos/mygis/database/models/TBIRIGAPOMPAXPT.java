...
public class TBIRIGAPOMPAXPT {
    ...
    public int getNama_Pompa() {
        return Nama_Pompa;
    }

    public void setNama_Pompa(int nama_Pompa) {
    ...
    public TBIRIGAPOMPAXPT() {
    }

    public TBIRIGAPOMPAXPT(int pId, int pOBJECTID, int pKodeAset, int pNama_Jaringan_Irigasi, int pNama_Pompa, String pKondisi,String pInformasi_Tambahan) {
        setId(pId);
    ...
    // Untuk insert data
    public TBIRIGAPOMPAXPT(int pOBJECTID, int pKodeAset, int pNama_Jaringan_Irigasi, int pNama_Pompa, String pKondisi,String pInformasi_Tambahan) {
        setOBJECTID(pOBJECTID);
        setKodeaset(pKodeAset);
