 ...
 */
public class FCIRIGATANGGULNTable implements AppTable {


    private static final String TAG = "FCIRIGATANGGULNTable";

    private static final String TABLE_NAME = "FCIRIGATANGGULN";
    ...
    public FCIRIGATANGGULNTable(Context pContext) {
        mContext = pContext;
    }
    ...
    public boolean insertData(Object data) {
        ...
        try {
            ...
            FCIRIGATANGGULN fcirigatangguln= (FCIRIGATANGGULN) data;
            ContentValues val = new ContentValues();
            val.put(OBJECTID, fcirigatangguln.getOBJECTID());
            val.put(kodeaset, fcirigatangguln.getKodeaset());
            val.put(Nama_Jaringan_Irigasi, fcirigatangguln.getNama_Jaringan_Irigasi());
    ...
    public boolean updateData(Object data) {
        ...
        try {
            ...
            String whereArgs[] = new String[] { String.valueOf(fcirigatangguln.getId()) };
    ...
    public <T> List<T> getData(Class<T> returnTypeClass, String whereClause, String[] whereArgs) {
        ...
        try {
            ...
            if (cur != null) {
                FCIRIGATANGGULN   fcirigatangguln = null;
                if (cur.moveToFirst()) {
                    do {
                        fcirigatangguln = new FCIRIGATANGGULN ();
                        //FCIRIGAPBWPRILN = new fcirigapbwpriln();
                        //myLayer = new MyLayer();
                        fcirigatangguln.setId(cur.getInt(0));
                        fcirigatangguln.setKodeaset(cur.getInt(1));
                        fcirigatangguln.setNama_Jaringan_Irigasi(cur.getInt(2));
                        data.add(returnTypeClass.cast(fcirigatangguln));
